...
const orderSlice = createSlice({
    ...
    reducers:{
        ...
        orderDetatilSuccess(state,action){
            return{
                ...state,
                loading:false,
                orderDetail:action.payload.order
...
export const {createOrderRequest,createOrderSuccess,createOrderFail,clearError,
    userOrdersRequest,userOrdersSuccess,userOrdersFail,
    updateOrdersRequest,updateOrdersSuccess,updateOrdersFail,
    deleteOrdersRequest,deleteOrdersSuccess,deleteOrdersFail,
    adminOrdersRequest,adminOrdersSuccess,adminOrdersFail,
    orderDetailRequest,orderDetatilSuccess,orderDetailFail,clearOrderDeleted,clearOrderUpdated
} = actions;
